...
public class Start extends JFrame {
	...
	public Start() {
		...
		button.setBounds(180, 294, 117, 29);
		panel.add(button);
		
		JButton button_1 = new JButton("\u5BA2\u6237\u7AEF\u5F00\u59CB");
		...
		button_1.setBounds(180, 151, 117, 29);
		panel.add(button_1);
		
		JButton btnNewButton = new JButton("\u670D\u52A1\u7AEF\u5F00\u59CB");
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					System.out.println("服务端启动"); 
					serverWindow mw=new serverWindow();
					System.out.println("服务端启动"); 
		...
		btnNewButton.setBounds(180, 226, 117, 29);
